                        ...
                        <table id="example" class="dd table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('group.chat', $group->data()['id']) }}"><i class="fas fa-eye"></i></a></td>
                                    <td align="center">
                                        <a href=""><i class="fas fa-edit"></i></a> &nbsp;&nbsp;
                                        <a href="" onclick="return confirm('Are you sure to delete this category?')"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endif
                                @endforeach
                            ...
                            <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                                <div class="profile-widget">
                                    ...
                                    <a href="javascript:void(0);" class="avatar">                                 
                                        <img src="{{ asset('admin_assets/img/profiles/avatar-02.jpg') }}" alt=""  data-url="{{ asset('frontend_assets/img/profiles/avatar-02.jpg') }}"></a>                                       
                                    </div>
                                    <div class="dropdown profile-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item admin_delete" data-id=""
                                                data-route="" href="#"
                                    ...
                                    <h4 class="admin-name m-t-10 mb-0 text-ellipsis"><a
                                            href="jsavscript:void(0);">{{ $group->data()['name'] }}</a></h4>
